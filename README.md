...
This recipe application primary function is to search any recipes and Display it in list form.
It also could be filtered, and searched by its own Categories located under the Search Bar.
It has 9 horizontal scrollable Categories to choose from, such as Chicken, Soup, Beef, Pizza and many others.
#### Recipes
...
When the recipes is clicked, it will lead user to other screen that's called as Recipe Details screen. On there, the details
of each of the recipes will be displayed.
